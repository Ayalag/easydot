        ...
        <div class="container container-term-and-condition p-3 mt-3 easyBlue600">
            ...
            <div class="d-flex">
                ...
                <label class="radio-inline mr-2">
                    <span>Acepto las <a href="{{ asset('/public/includes/polizas/SURA-CONDICIONES-GENERALES-PERSONAS.pdf') }}" target="_blank" class="easyLigth600">condiciones generales</a> del producto seleccionado</span>
                </label>
