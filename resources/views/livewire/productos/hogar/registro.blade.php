                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select wire:model="selectedProvincia2"
                                    class="form-control input__style @if ($errors->has('selectedProvincia2'))  is-invalid @endif"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select wire:model="selectedDistrito2"
                                    class="form-control input__style @if ($errors->has('selectedDistrito2'))  is-invalid @endif "
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select wire:model.defer="selectedCorregimiento2"
                                    class="form-control input__style @if ($errors->has('selectedCorregimiento2'))  is-invalid @endif"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input wire:model.defer="barrio2" type="text"
                                    class="form-control input__style @if ($errors->has('barrio2'))  is-invalid @endif"
                                    id="barrio2" placeholder="Barrio / P.H">
                            </div>
                            <div class="form-group col-md-6">
                                {{-- <label for=""></label> --}}
                                <input wire:model.defer="casa2" type="text"
                                    class="form-control input__style @if ($errors->has('casa2'))  is-invalid @endif"
