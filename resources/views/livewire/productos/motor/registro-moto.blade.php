    ...
    <form wire:submit.prevent="submit" enctype="multipart/form-data">
        ...
        <div class="datos-de-ppp pt-4">
            <div class="container-fluid container-registro-contactos shadow pt-4">
                <div class="form-row">
                    <div
                        class="col-xs-6 col-sm-6 col-md-5 col-lg-4 easyBlue600 @if ($errors->has('ppe'))  text-danger @endif">
                        ¿Eres una persona <br>
                        políticamente expuesta?
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-5 col-lg-6">
                        <label class="h4" for="ppeSi">Si</label>
                        <input wire:model.defer="ppe" type="radio" name="ppe" id="ppeSi" value="ppeSi"
                            wire:click="$set('showppe',true)">
                        <label for="" class="h4" for="ppeNo">No</label>
                        <input wire:model.defer="ppe" type="radio" name="ppe" id="ppeNo" value="ppeNo"
                            wire:click="$set('showppe',false)">
                    </div>
                </div>
        ...
        <div class="container-fluid container-aditional__person shadow easyBlue400 mt-4">
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 text-center">
                <div class="form-check-inline ">
                    <div
                        class="underline col-xs-12 col-sm-12 col-md-12 col-lg-12 easyBlue600 @if ($errors->has('aditionalPerson'))  text-danger @endif">
                        ¿deseas incluir una persona adicional?
                    </div>
                    <label class=" form-check-label mr-1 h4" for="">Si</label>
                    <input wire:model.defer="aditionalPerson" class="form-check-input" type="radio"
                        name="aditionalPerson" id="aditionalPerson_Si" value="si"
                        wire:click="$set('showaditionalPerson',true)">
                    <label class="form-check-label mr-1 h4" for="">No</label>
                    <input wire:model.defer="aditionalPerson" class="form-check-input" type="radio"
                        name="aditionalPerson" id="aditionalPerson_No" value="no"
                        wire:click="$set('showaditionalPerson',false)">
                </div>
            </div>
        </div>
        @if($showaditionalPerson)
        <div class="container-fluid p-3">
            <div class="col-12 text-center">
                <div class="registro-datos__subtitle">
                    <p class="underline">datos personales</p>
        ...
        <div class="container-fluid container-registro-datos shadow ">
            <div class="p-4">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        {{-- <label for="nombres">nombres</label> --}}
                        <input type="text" class="form-control input__style @error('ap_nombres') is-invalid @enderror"
                            id="ap_nombres" placeholder="nombres" wire:model.defer="ap_nombres">
                    </div>
                    <div class="form-group col-md-6">
                        {{-- <label for="apellidos">apellidos</label> --}}
                        <input type="text" class="form-control input__style @error('ap_apellidos') is-invalid @enderror"
                            id="ap_apellidos" placeholder="apellidos" wire:model.defer="ap_apellidos">
                    </div>
                </div>
                <div class="form-row mb-2">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="form-check-inline" style="width: 100%;justify-content: center;">
                            <label
                                class="form-check-label pr-2 easyBlue600 ml-2 mb-2 @if ($errors->has('ap_typeId')) text-danger @endif"
                                for="inlineRadio1">Cédula</label>
                            <input wire:model.defer="ap_typeId" class="form-check-input mb-2" type="radio"
                                name="ap_identificacion" id="ap_cedula" value="ap_cedula"
                                wire:click="$set('showPais',false)">
                            <label
                                class="form-check-label mr-2 easyBlue600 mb-2 @if ($errors->has('ap_typeId')) text-danger @endif"
                                for="inlineRadio1">Pasaporte</label>
                            <input wire:model="ap_typeId" class="form-check-input mb-2" type="radio"
                                name="ap_identificacion" id="ap_pasaporte" value="pasaporte"
                                wire:click="$set('showPais',true)">
                        </div>

                        <div class="form-group">
                            <input wire:model.defer="ap_identificacion" type="text"
                                class="form-control input__style  @error('ap_identificacion') is-invalid @enderror"
                                id="ap_identificacion" placeholder="identificacion">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-5">
                        <div class="form-check-inline justify-content-center" style="width: inherit">
                            <label
                                class="easyBlue600 pb-2 
                             @if($errors->has('ap_dia') || $errors->has('ap_mes') || $errors->has('ap_año')) text-danger @endif">Fecha
                                de nacimiento</label>
                        </div>
                        <div class="form-group tooltipAge">

                            <div class="d-flex">
                                <select wire:model.defer="ap_dia"
                                    class="col-xs-12 col-sm-4 col-md-4 col-lg-4 form-control input__style mr-1 @error('ap_dia') is-invalid @enderror"
                                    id="ap_birthdayDay" placeholder="dd">
                                    <option value="" selected>día</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_mes"
                                    class="col-xs-12 col-sm-4 col-md-4 col-lg-4 form-control input__style mr-1 @error('ap_mes') is-invalid @enderror"
                                    id="ap_birthdayMonth" placeholder="mm">
                                    <option value="" selected>mes</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_año"
                                    class="col-xs-12 col-sm-4 col-md-4 col-lg-4 form-control input__style mr-1  @error('ap_año') is-invalid @enderror"
                                    id="ap_birthdayYear" placeholder="aa">
                                    <option value="" selected>año</option>
                                    <option value="2022">2022</option>
                                    <option value="2021">2021</option>
                                    <option value="2020">2020</option>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-3 text-center">
                        <div class="form-check-inline ">
                            <label
                                class="easyBlue600 pb-3 @if ($errors->has('ap_genero')) text-danger @endif">Género</label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label mr-4 h4" for="">M</label>
                            <input wire:model.defer="ap_genero" class="form-check-input" type="radio" name="ap_genero"
                                id="ap_hombre" value="hombre">
                            <label class="form-check-label mr-4 h4" for="">F</label>
                            <input wire:model.defer="ap_genero" class="form-check-input" type="radio" name="ap_genero"
                                id="ap_mujer" value="mujer">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-sm-12 col-md-3">
                        <select wire:model.defer="ap_eCivil"
                            class="form-control input__style @error('ap_eCivil') is-invalid @enderror"
                            data-live-search="true" title="eCivil" name="ap_eCivil" id="ap_eCivil">
                            <option>estado civil</option>
                            <option value="soltero">Soltero</option>
                            <option value="casado">Casado</option>
                            <option value="viudo">Viudo</option>
                    ...
                    <div class="form-group col-sm-12 col-md-5 text-center">
                        ...
                        <div class="input-file" name="upload" x-data="{ isUploading: false, progress: 0 }"
                            ...
                            <input id="file-upload" type="file" wire:model="ap_cedulaFoto" />
                            <div class="progress customBar">
                                <div x-show.transition="true" class="progress-bar" role="progressbar" aria-valuenow="75"
                                    aria-valuemin="0" aria-valuemax="100" x-bind:style="`width:${progress}%`"></div>
                            </div>
                            @if ($ap_cedulaFoto)
                            <div class="preview">
                                <img class="img-thumbnail img-thumbnail__id "
                                    src="{{ $ap_cedulaFoto->temporaryUrl() }}">
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-4" style="width: 282px">
                        @if($showPais)
                        <select wire:model.defer="ap_pais"
                            class="form-control input__style @error('ap_pais') is-invalid @enderror"
                            data-live-search="true" title="pais" name="ap_pais" id="ap_pais">
                            <option value=''>Nacionalidad</option>
                            <option value="Afganistan">Afghanistan</option>
                            <option value="Albania">Albania</option>
                            <option value="Algeria">Algeria</option>
        ...
        <div class="datos-de-contacto">
            ...
            <div class="container-fluid container-registro-contactos shadow p-3">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select wire:model="selectedProvincia2"
                            class="form-control input__style @error('selectedProvincia2') is-invalid @enderror"
                            data-live-search="true" title="Provincia" name="provincia2" id="ap_provincia">
                            <option value="" selected>Provincia</option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select wire:model="selectedDistrito2"
                            class="form-control input__style @error('selectedDistrito2') is-invalid @enderror"
                            data-live-search="true" title="Distrito" name="distrito2" id="distrito2">
                            <option value="" selected>Distrito</option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select wire:model.defer="selectedCorregimiento2"
                            class="form-control input__style @error('selectedCorregimiento2') is-invalid @enderror"
                            data-live-search="true" title="Corregimiento" name="corregimiento2" id="corregimiento2">
                            <option value="" selected>Corregimiento</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        {{-- <label for=""></label> --}}
                        <input wire:model.defer="ap_barrio" type="text"
                            class="form-control input__style @error('ap_barrio') is-invalid @enderror" id="ap_barrio"
                            placeholder="Barrio / P.H">
                    </div>
                    <div class="form-group col-md-6">
                        {{-- <label for=""></label> --}}
                        <input wire:model.defer="ap_casa" type="text"
                            class="form-control input__style @error('ap_casa') is-invalid @enderror" id="ap_casa"
                            placeholder="N° Casa/Apto.">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        {{-- <label for="">celular</label> --}}
                        <input wire:model.defer="ap_celular" type="tel"
                            class="form-control input__style @error('ap_celular') is-invalid @enderror" id="ap_celular"
                            placeholder="Celular">
                    </div>
                    <div class="form-group col-md-6">
                        {{-- <label for="">correo electrónico</label> --}}
                        <input wire:model.defer="ap_contactMail" type="email"
                            class="form-control input__style @error('ap_contactMail') is-invalid @enderror" id="email"
                            placeholder="Correo electrónico">
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid container-registro-contactos shadow pt-4">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-4 text-center">
                                    <div class="form-check-inline ">
                                        <div
                                            class="col-xs-12 col-sm-12 col-md-10 col-lg-12 easyBlue600 @if ($errors->has('ap_ppe'))  text-danger @endif">
                                            ¿Eres una persona <br>
                                            políticamente expuesta?
                                        </div>
                                        <label class=" form-check-label mr-1 h4" for="">Si</label>
                                        <input wire:model.defer="ap_ppe" class="form-check-input" type="radio"
                                            name="ap_ppe" id="ap_ppeSi" value="ap_ppeSi"
                                            wire:click="$set('ap_showppe',true)">
                                        <label class="form-check-label mr-1 h4" for="">No</label>
                                        <input wire:model.defer="ap_ppe" class="form-check-input" type="radio"
                                            name="ap_ppe" id="ap_ppeNo" value="ap_ppeNo"
                                            wire:click="$set('ap_showppe',false)">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="show-hide" id="show-hide">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for=""></label>
                            <input wire:model.defer="ap_ppecargo" type="text"
                                class="form-control input__style @error('ap_ppecargo') is-invalid @enderror"
                                id="ap_cargo" placeholder="Cargo">
                        </div>
                        <div class="form-group col-md-6">
                            <div class="container-ppe__activo d-flex flex-column">
                                <div class="text-center @error('ap_ppe_activo') is-invalid @enderror">
                                    ¿estás en el cargo <br> actualmente?
                                </div>
                                <div class="ppe_otipons text-center">
                                    <label class=" form-check-label mr-4 h5" for="">Si</label>
                                    <input wire:model.defer="ap_ppe_activo" class="form-check-input" type="radio"
                                        name="ap_ppe_activo" id="ap_ppe_activoSi" value="si"
                                        wire:click="$set('ap_showppeend',false)">
                                    <label class="form-check-label mr-4 h5" for="">No</label>
                                    <input wire:model.defer="ap_ppe_activo" class="form-check-input" type="radio"
                                        name="ap_ppe_activo" id="ap_ppe_activoNo" value="no"
                                        wire:click="$set('ap_showppeend',true)">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6 text-center">
                            <label class="easyBlue600">Fecha de inicio del cargo</label>
                            <div class="col-12 d-flex">
                                <select wire:model.defer="ap_ppe_inicio_dia"
                                    class="form-control input__style mr-2 @error('ap_ppe_inicio_dia') is-invalid @enderror"
                                    id="ap_dd" placeholder="dd">
                                    <option value="" selected>dd</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_ppe_inicio_mes"
                                    class="form-control input__style mr-2 @error('ap_ppe_inicio_mes') is-invalid @enderror"
                                    id="ap_mm" placeholder="mm">
                                    <option value="" selected>mm</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_ppe_inicio_año"
                                    class="form-control input__style mr-2 @error('ap_ppe_inicio_año') is-invalid @enderror"
                                    id="ap_aa" placeholder="aa">
                                    <option value="" selected>aa</option>
                                    <option value="2022">2022</option>
                                    <option value="2021">2021</option>
                                    <option value="2020">2020</option>
                        ...
                        <div class="form-group col-md-6 text-center">
                            <label class="easyBlue600">Fecha de finalización</label>
                            <div class="col-12 d-flex">
                                <select wire:model.defer="ap_ppe_final_dia"
                                    class="form-control input__style mr-2 @error('ap_ppe_final_dia') is-invalid @enderror"
                                    id="ap_ddend" placeholder="ddend">
                                    <option value="" selected>dd</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_ppe_final_mes"
                                    class="form-control input__style mr-2  @error('ap_ppe_final_mes') is-invalid @enderror"
                                    id="ap_mmed" placeholder="mmed">
                                    <option value="" selected>mm</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <select wire:model.defer="ap_ppe_final_año"
                                    class="form-control input__style mr-2  @error('ap_ppe_final_año') is-invalid @enderror"
                                    id="ap_aaend" placeholder="aaend">
                                    <option value="" selected>aa</option>
                                    <option value="2022">2022</option>
                                    <option value="2021">2021</option>
                                    <option value="2020">2020</option>
        ...
        <div class="container container-term-and-condition p-3 mt-3 easyBlue600">
            <div class="d-flex">
                ...
                <span>Acepto los <a href="{{ route('terminos-y-condiciones') }}" target="_blank"
                        class="easyLigth600">Términos y condiciones</a> de <span class="easyRose600">easy</span>. así
                    como la politica de <br> <span class="easyLigth600">Protección de datos</span>.</span>
                </label>
