            ...
            <div class="container container-datos__cliente mt-3">
                ...
                <div>
                    <div class="form-row p-2">
                        ...
                        <div class="col-4">
                            <label for="placa">Distrito</label>
                            <input disabled value="{{ $response[0]->hogar_distrito }}" type=" text"
                                class="form-control input__style_comprobante" id="dis" placeholder="">
                        </div>
                        <div class="col-4">
                            <label for="marca">Corregimiento</label>
                            <input disabled value="{{ $response[0]->hogar_corregimiento }}" type="text"
                                class="form-control input__style_comprobante" id="corr" placeholder="">
                        </div>
                    </div>
                    <div class="form-row p-2">
                       
                        <div class="col-6">
                            <label for="year">Barrio</label>
                            <input disabled value="{{ $response[0]->hogar_barrio }}" type="text"
                                class="form-control input__style_comprobante" id="barrio" placeholder="">
                        </div>
                        <div class="col-6">
