...
<div class="container step-to-buy">
    ...
    <div class="container container-steps mb-5">
        <div class="steps-by-steps">
            <div class="row">
                <div class="col-md-12 step-one-letter basic-drop-shadow">
                    <div>1</div>
                    <div>
            ...
            <div class="row">
                <div class="col-md-12 step-two-letter basic-drop-shadow">
                    <div>2</div>
                    <div>
            ...
            <div class="row ">
                <div class="col-md-12 step-three-letter basic-drop-shadow">
                    <div>3</div>
                    <div>
        ...
        <div class="row">
            <div class="img-fluid container-step__image2">
...
<div class="container-fluid container-comments pb-5">
    {{-- <div class="container-persona__logo">
