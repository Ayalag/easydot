    ...
    <div class="slick1">
        <div class="item-slick1" style="background-image: url('public/includes/images/slider/insurance_final.png')">
            <div class="container container-slider">
                ...
                <x-btn-main class='fntw-800' link="/autos">comprar ahora</x-btn-main>
            </div>
        </div>
        ...
        <div class="item-slick1" style="background-image: url('public/includes/images/slider/insurance_final.png')">
            <div class="container container-slider">
                ...
                <x-btn-main class='fntw-800' link="/persona">comprar ahora</x-btn-main>
            </div>
        </div>
        ...
        <div class="item-slick1" style="background-image: url('public/includes/images/slider/insurance_final.png')">
            <div class="container container-slider">
                ...
                <x-btn-main class='fntw-800' link="/hogar">comprar ahora</x-btn-main>
            </div>
        </div>
    </div>
</div>
