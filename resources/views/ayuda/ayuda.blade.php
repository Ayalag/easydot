                    ...
                    <div class="answers">
                        <div class="bigger-margin">1.&nbsp;¿Es seguro el pago en línea al comprar mis pólizas?
                            <ul>
                                <li>
                                    <ul>
                                        <li>La plataforma de pago que utilizamos se llama Páguelo Fácil, la cual cuenta
                                            con todas las medidas de seguridad para asegurar que las transacciones se
                                            realicen de manera correcta y segura.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <br>
                        <div class="bigger-margin">2.&nbsp;¿Qué es un comprobante de compra?
                            <ul>
                                <li>
                                    <ul>
                                        <li>Es un documento que funciona como constancia de contar con el seguro que
                                            adquiriste y está respaldado por la aseguradora de tu elección al momento de
                                            comprar la póliza.<br />
                                            Recuerda que ésta es una constancia, más no la póliza original.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <li>
                                    <ul>
                                        <li>La póliza original estará llegando al correo electrónico que nos indicaste
                                            ...
                                            un comprobante que garantiza la compra de tu póliza.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <li>
                                    <ul>
                                        <li>En caso de atención directa, asistencia y/o reclamos puedes contactar a las
                                            aseguradoras en los números detallados en esta sección.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="answers">
                                ...
                                <li>
                                    <ul>
                                        <li>Lo primero es verificar si hay heridos. Luego debes informar de inmediato a
                                            ...
                                            si es necesario llamar a la autoridad correspondiente (ATTT).</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="bigger-margin">2.&nbsp;¿Qué significa SOAT?
                            <ul>
                                <li>
                                    <ul>
                                        <li>Significa Seguro Obligatorio de Accidentes de Tránsito.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li>
                                    <ul>
                                        <li>Es la cobertura que aplica para hacer frente a las lesiones ocasionadas a
                                            otras personas fuera del vehículo asegurado en caso de un accidente.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li>
                                    <ul>
                                        <li>Es la cobertura que hace frente a los daños materiales ocasionados a los
                                            bienes de otras personas en caso de un accidente.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="answers">
                        <div class="bigger-margin">1.&nbsp;¿Cuáles son los tipos de mascotas puedo asegurar?
                            <ul>
                                <li>
                                    <ul>
                                        <li>Puedes asegurar perros y gatos.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li>
                                    <ul>
                                        <li>Puedes asegurar tus muebles, equipos electrónicos como TVs,
                                            electrodomésticos como refrigeradoras, entre otros.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li>
                                    <ul>
                                        <li>No importa si eres propietario o si alquilas una casa o apartamento, siempre
                                            que dicho contenido sea de tu pertenencia.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
