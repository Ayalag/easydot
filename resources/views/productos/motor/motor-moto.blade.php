...
<div class="container-fluid container-productos pt-5">
    ...
    <div class="row justify-content-center pt-3 mb-3 car-options">
        <div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-3 no-gutters rounded-lg d-flex justify-content-around align-items-center mr-2 pb-4 pt-2">
            <input id="soat" type="radio" name="categoria" checked>
            <label for="soat" class="clickableCat">soat</label>
        </div>
        <div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-3 rounded-lg d-flex justify-content-around align-items-center mr-2 pb-4 pt-2">
            <input id="basico" type="radio" name="categoria">
            <label for="basico" class="clickableCat">básico</label>
        </div>
        <div class="col-xl-1 col-lg-2 col-md-2 col-sm-3 col-3 rounded-lg d-flex justify-content-around align-items-center pb-4 pt-2">
