                    ...
                    <div>
                        <div class="card card-container__insurance">
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <div class="card-subtitle">emergencias médicas</div>
                                    <p class="card-text underline pt-2 mb-2 easyBlue600">coberturas</p>
                                    ...
                                    <div class="card-list__items">
                                        <ul>
                                            ...
                                            <li>Tratamiento y servicios dentales &#09; en caso de accidentes.</li>
                                            <li>Descuentos de hasta 50% en red médica de Sura</li>
                                            <li>Asistencia funeraria y repatriación</li>
                                        </ul>
                                    </div>
